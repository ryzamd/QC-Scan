...
ProcessingItemModel _$ProcessingItemModelFromJson(Map<String, dynamic> json) =>
  ProcessingItemModel(
    ...
    qcQtyIn: json['qc_qty_in'] != null ? (json['qc_qty_in'] as num).toDouble() : 0,
    qcQtyOut: json['qc_qty_out'] != null ? (json['qc_qty_out'] as num).toDouble() : 0,
    zcWarehouseQtyInt: json['zc_warehouse_qty_int'] != null ? (json['zc_warehouse_qty_int'] as num).toDouble() : 0,
    zcWarehouseQtyOut: json['zc_warehouse_qty_out'] != null ? (json['zc_warehouse_qty_out'] as num).toDouble() : 0,
